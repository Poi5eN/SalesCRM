...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen lg:h-screen lg:overflow-hidden grid grid-cols-1 lg:grid-cols-2 bg-[var(--content-bg)] text-[var(--text-primary)] transition-colors duration-200">
      {/* Left: Content, Illustration & Branding */}
      <div className="hidden lg:flex flex-col justify-between p-12 bg-[var(--sidebar-bg)] border-r border-[var(--border)] relative overflow-hidden">
        ...
        <div className="relative my-auto py-6 flex flex-col items-center text-center">
          <div className="max-w-md space-y-4">
            <h1 className="text-4xl lg:text-4xl font-extrabold tracking-tight leading-tight text-[var(--text-primary)]">
              The next generation of <br />
              <span className="underline decoration-indigo-500 decoration-wavy">Sales Intelligence</span>.
            </h1>
            <p className="text-[var(--text-secondary)] text-sm leading-relaxed">
              Close more deals, manage your pipeline with AI, and grow your business with a CRM designed for productive focus.
            </p>
          </div>
          <div className="w-64 h-64 lg:w-72 lg:h-72 mt-6">
            <img 
