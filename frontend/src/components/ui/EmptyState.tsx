...
export function EmptyState({ title, description, actionText, onAction, icon: Icon, variant, imageUrl }: EmptyStateProps) {
  return (
      ...
      <div className="relative mb-6 group flex items-center justify-center">
        ...
        {imageUrl ? (
          <div className="relative w-64 h-48 flex items-center justify-center">
            <img src={imageUrl} alt={title} className="max-w-full max-h-full object-contain dark:opacity-85 dark:brightness-110" />
          </div>
        ) : (
