...
export class TenantService {
  ...
  static async listUsers(tenantId: string, page = 1, limit = 10) {
  ...
  static async updateUser(tenantId: string, userId: string, data: { status?: any; roleId?: string }) {
  ...
  static async softDeleteUser(tenantId: string, userId: string, reassignToUserId: string) {
