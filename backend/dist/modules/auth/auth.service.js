...
export class AuthService {
    ...
    static async refresh(refreshToken) {
        ...
        try {
            const decoded = jwt.default.verify(refreshToken, env.JWT_REFRESH_SECRET);
    ...
    static async me(userId) {
        ...
        const permissions = user.userRoles.flatMap(ur => ur.role.permissions.map(rp => `${rp.permission.resource}:${rp.permission.action}`));
