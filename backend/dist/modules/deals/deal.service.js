...
export class DealService {
    static async listDeals(tenantId, filters) {
        const { stageId, status, assignedToId, contactId, companyId, minValue, maxValue, expectedCloseAtFrom, expectedCloseAtTo, createdAtFrom, createdAtTo, isStale, page = 1, limit = 10, sortBy = 'createdAt', sortOrder = 'desc' } = filters;
