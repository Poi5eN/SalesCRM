...
import { createProposalSchema, updateProposalSchema, addProposalItemSchema, updateProposalItemSchema, proposalFilterSchema, respondProposalSchema } from './proposal.schemas.js';
const router = Router();
